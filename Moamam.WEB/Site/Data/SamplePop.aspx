<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage_Modal.master" AutoEventWireup="true" CodeFile="SamplePop.aspx.cs" Inherits="Site_Data_SamplePop" %>
...
<script type="text/javascript">
    ...
    function jsfn_Search() {
        ...
        var SpName = "UP_Site_Data_SamplePop_List1_R";
...
<!-- 조회조건 Start -->
    <article id="search">
	    <div class="search row1"><!-- 한 줄: row1, 두 줄: row2, 세 줄: row3 -->
		    <div>
			    <label for="">아이템명</label>
                <%--<asp:TextBox ID="txtSerchName" runat="server" CssClass="input hangleDefault" ClientIDMode="Static" style="width:200px;height:30px;" AutoPostBack="false"></asp:TextBox> --%>
