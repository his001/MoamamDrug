...
public partial class Site_PopupPage_SupplierNameList : BasePage
{
    ...
    private void getDateItemName()
    {
        ...
        try
        {
            ...
            {
                ds = (new CooperativeItem()).GetCooperativeItemNameToList(txtSerchName.Text.ToString().Trim(), ucPaging.RowCount, Convert.ToInt32(ucPaging.PageNo),ddlName.SelectedValue);
