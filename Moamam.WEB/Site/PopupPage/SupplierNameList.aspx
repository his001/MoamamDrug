 <%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage_Popup.master" AutoEventWireup="true" CodeFile="SupplierNameList.aspx.cs" Inherits="Site_PopupPage_SupplierNameList" %> 
        ...
        <table >
                <tr > 
                    <td colspan="2"><asp:DropDownList runat="server" ID="ddlName" Height="30">
                                        <asp:ListItem Text="협력업체명" Value="name"></asp:ListItem>
                                        <asp:ListItem Text="협력업체코드" Value="code"></asp:ListItem>
                                    </asp:DropDownList> 
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:Repeater ID="rptTransfer1" runat="server">  
                        <ItemTemplate>
                                    <tr> 
                                        <td class="t_c"><%#nEval("SUPPLIER")%></td>
                                        <td style="color:blue;text-align:left;">
                                            <a href="javascript:opener.SerchSuppClick('<%#nEval("SUPPLIER")%>','<%#nEval("SUP_NAME")%>','<%#nEval("WH")%>','<%#nEval("ORDER_GROUP")%>');window.close();"> 
                                            &nbsp;<asp:Label ID="lbLinkValue" runat="server" ForeColor="Blue"> <%#nEval("SUP_NAME")%></asp:Label>
                                            </a>
                                        </td>
                                    </tr> 
                        </ItemTemplate> 
