...
/// <summary>
/// DataCommon의 요약 설명입니다.
/// </summary>
public class DataCommon : System.Web.UI.Page
{
	public DataCommon()
	{
		//
    ...
    public void baseCommonSpCaller(string spName, SqlParameterCollection param)
    {
    ...
    public void baseCommonCallSpGetJson(string spName, SqlParameterCollection param)
    {
        string sErrorType = string.Empty;       //E:Error, I:Information, C:Confirm, CT:커스텀 이벤트
        string sErrorMessage = string.Empty;
